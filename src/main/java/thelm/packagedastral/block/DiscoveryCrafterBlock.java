...
public class DiscoveryCrafterBlock extends BaseBlock {
	...
	public static final Item ITEM_INSTANCE = new BlockItem(INSTANCE, new Item.Properties().group(PackagedAstral.ITEM_GROUP)).setRegistryName("packagedastral:discovery_crafter");
