...
public class GuiConstellationCrafter extends GuiContainerTileBase<ContainerConstellationCrafter> {
	...
	public GuiConstellationCrafter(ContainerConstellationCrafter container) {
		super(container);
		xSize = 198;
		ySize = 217;
	}
