...
public class HostHelperTileConstellationCrafter extends HostHelperTile<TileConstellationCrafter> {

	public HostHelperTileConstellationCrafter(TileConstellationCrafter tile) {
		super(tile);
	...
	public void ejectItem() {
		if(isActive()) {
			...
			int endIndex = tile.isWorking ? 21 : 0;
