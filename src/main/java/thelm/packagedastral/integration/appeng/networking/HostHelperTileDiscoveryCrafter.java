...
public class HostHelperTileDiscoveryCrafter extends HostHelperTile<TileDiscoveryCrafter> {

	public HostHelperTileDiscoveryCrafter(TileDiscoveryCrafter tile) {
		super(tile);
