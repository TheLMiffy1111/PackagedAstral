...
public class HostHelperTileAttunementCrafter extends HostHelperTile<TileAttunementCrafter> {

	public HostHelperTileAttunementCrafter(TileAttunementCrafter tile) {
		super(tile);
	...
	public void ejectItem() {
		if(isActive()) {
			...
			int endIndex = tile.isWorking ? 13 : 0;
