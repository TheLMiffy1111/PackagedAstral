...
public class AEConstellationCrafterTile extends ConstellationCrafterTile implements IGridHost, IActionHost {

	public BaseGridBlock<AEConstellationCrafterTile> gridBlock;
	public MachineSource source;
	public IGridNode gridNode;

	public AEConstellationCrafterTile() {
		super();
