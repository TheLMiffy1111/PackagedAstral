...
public class AETraitCrafterTile extends TraitCrafterTile implements IGridHost, IActionHost {

	public BaseGridBlock<AETraitCrafterTile> gridBlock;
	public MachineSource source;
	public IGridNode gridNode;

	public AETraitCrafterTile() {
		super();
