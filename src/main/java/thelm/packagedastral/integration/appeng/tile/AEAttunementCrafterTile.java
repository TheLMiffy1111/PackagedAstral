package thelm.packagedastral.integration.appeng.tile;
...
public class AEAttunementCrafterTile extends AttunementCrafterTile implements IGridHost, IActionHost {

	public BaseGridBlock<AEAttunementCrafterTile> gridBlock;
	public MachineSource source;
	public IGridNode gridNode;

	public AEAttunementCrafterTile() {
		super();
